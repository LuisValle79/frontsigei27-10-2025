...
import type { InstitutionSummary, InstitutionWithUsersResponse, Classroom } from '../models/integration.model';

interface InstitutionSelectorProps {
  onInstitutionSelected: (institution: InstitutionWithUsersResponse) => void;
  onClassroomSelected: (classroom: Classroom) => void;
  selectedInstitution?: InstitutionWithUsersResponse | null;
...
export const InstitutionSelector: React.FC<InstitutionSelectorProps> = ({
  ...
  const loadInstitutions = async () => {
    ...
    try {
      ...
      const errorMessage = err instanceof Error ? err.message : 'Error al cargar instituciones';
