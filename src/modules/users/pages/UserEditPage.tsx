...
import { Save, X, User as UserIcon, Mail, Phone, MapPin } from "lucide-react";
  ...
  const validateField = (name: string, value: string): string => {
    switch (name) {
      ...
      case "phone":
        ...
        if (!value.startsWith("9")) return "Debe comenzar con 9";
        return "";
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <input
                ...
                onChange={handleChange}
                onBlur={handleBlur}
                className={`w-full px-3 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent ${getFieldError("institutionId")
                    ? "border-red-500"
                    : "border-gray-300"
                  }`}
