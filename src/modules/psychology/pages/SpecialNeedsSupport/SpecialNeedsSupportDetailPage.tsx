...
export function SpecialNeedsSupportDetailPage() {
  ...
  const [support, setSupport] = useState<SpecialNeedsSupport | null>(null);
  ...
  const loadSupport = async (supportId: string) => {
    try {
      ...
      Swal.fire({
        icon: 'error',
        title: 'Error',
        text: 'No se pudo cargar el soporte.',
      });
        ...
        <div className="bg-white shadow rounded-lg">
          ...
          <div className="px-4 py-5 sm:px-6 border-b border-gray-200 flex justify-between items-center">
            ...
            <div className="flex space-x-3">
              ...
              <button
                onClick={() =>
                  navigate(`/psychology/supports/edit/${support.studentId}`)
                }
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="lg:col-span-2 space-y-6">
                ...
                <section className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <Field label="ID del Estudiante" value={support.studentId} />
                    <Field label="ID del Aula" value={support.classroomId} />
                    <Field label="ID de la Institución" value={support.institutionId} />
                ...
                <section className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      ...
                      <Field label="Diagnosticado Por" value={support.diagnosedBy} />
              ...
              <div className="space-y-6">
                ...
                <section className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <Field label="Notas" value={support.progressNotes ?? 'No hay notas de progreso'} />
                </section>
              </div>
            </div>
          </div>
