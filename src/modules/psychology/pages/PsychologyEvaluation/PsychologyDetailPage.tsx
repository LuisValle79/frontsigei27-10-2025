...
export function PsychologyDetailPage() {
  ...
  // Función para editar evaluación con confirmación
  ...
  const handleDeactivate = async () => {
    const result = await Swal.fire({
      ...
      text: 'Esta acción realizará un eliminado lógico. La evaluación se marcará como inactiva pero no se eliminará permanentemente.',
      icon: 'warning',
      showCancelButton: true,
    ...
    if (result.isConfirmed) {
      try {
        ...
        await Swal.fire({
          title: '¡Evaluación desactivada!',
          text: 'La evaluación ha sido desactivada correctamente',
          icon: 'success',
        ...
        await Swal.fire({
          title: 'Error',
          text: 'No se pudo desactivar la evaluación. Inténtalo nuevamente.',
          icon: 'error',
          confirmButtonColor: '#EF4444',
          confirmButtonText: 'Entendido',
          background: '#ffffff',
  ...
  const handleReactivate = async () => {
    const result = await Swal.fire({
      ...
      text: 'La evaluación volverá a estar activa y disponible para edición.',
      icon: 'question',
      showCancelButton: true,
      confirmButtonColor: '#10B981',
      cancelButtonColor: '#6B7280',
    ...
    if (result.isConfirmed) {
      try {
        ...
        await Swal.fire({
          title: '¡Evaluación reactivada!',
          text: 'La evaluación ha sido reactivada correctamente',
          icon: 'success',
          confirmButtonColor: '#10B981',
          confirmButtonText: 'Entendido',
          background: '#ffffff',
        ...
        await Swal.fire({
          title: 'Error',
          text: 'No se pudo reactivar la evaluación. Inténtalo nuevamente.',
          icon: 'error',
          confirmButtonColor: '#EF4444',
          confirmButtonText: 'Entendido',
          background: '#ffffff',
          ...
          <div className="bg-white rounded-lg shadow border p-6">
            <div className="flex items-start justify-between">
              ...
              <div className="flex gap-3">
                ...
                <button onClick={() => navigate("/psicologia")} className="px-4 py-2 bg-white hover:bg-gray-50 text-gray-700 rounded-lg font-medium border border-gray-300 flex items-center gap-2">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
